...
2. Будет закупщик мяса. Нужно заранее внести список в табличку выше.
3. Будет закупщик овощей (поедет на рынок). Тоже самое, нужно заранее внести список в табличку выше.
